 ...
 */
#define kAPP_ID     @"216888"
#define kAPI_Key    @"a7f20d7bf9a2487993752533ac13232d"
...
/**
 * 获取用户状态
 * @param param包含接口参数所需数据成员的ROUserStatusRequestParam对象。
 * @param delegate 实现RenrenDelegate协议的类型对象。
 */
-(void)getUserStatus:(ROUserStatusRequestParam *)param andDelegate:(id<RenrenDelegate>)delegate;
